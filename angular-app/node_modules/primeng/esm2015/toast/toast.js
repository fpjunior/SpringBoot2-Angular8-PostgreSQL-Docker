...
function ToastItem_ng_container_3_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵclassMap("p-toast-message-icon pi" + (ctx_r1615.message.icon ? " " + ctx_r1615.message.icon : ""));
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction4(5, _c1, ctx_r1615.message.severity == "info", ctx_r1615.message.severity == "warn", ctx_r1615.message.severity == "error", ctx_r1615.message.severity == "success"));
    ɵngcc0.ɵɵadvance(3);
    ɵngcc0.ɵɵtextInterpolate(ctx_r1615.message.summary);
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵtextInterpolate(ctx_r1615.message.detail);
} }
function ToastItem_button_4_Template(rf, ctx) { if (rf & 1) {
    const _r1619 = ɵngcc0.ɵɵgetCurrentView();
    ɵngcc0.ɵɵelementStart(0, "button", 10);
    ɵngcc0.ɵɵlistener("click", function ToastItem_button_4_Template_button_click_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r1619); const ctx_r1618 = ɵngcc0.ɵɵnextContext(); return ctx_r1618.onCloseIconClick($event); })("keydown.enter", function ToastItem_button_4_Template_button_keydown_enter_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r1619); const ctx_r1620 = ɵngcc0.ɵɵnextContext(); return ctx_r1620.onCloseIconClick($event); });
...
function Toast_p_toastItem_2_Template(rf, ctx) { if (rf & 1) {
    const _r1626 = ɵngcc0.ɵɵgetCurrentView();
    ɵngcc0.ɵɵelementStart(0, "p-toastItem", 3);
    ɵngcc0.ɵɵlistener("onClose", function Toast_p_toastItem_2_Template_p_toastItem_onClose_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r1626); const ctx_r1625 = ɵngcc0.ɵɵnextContext(); return ctx_r1625.onMessageClose($event); })("@toastAnimation.start", function Toast_p_toastItem_2_Template_p_toastItem_animation_toastAnimation_start_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r1626); const ctx_r1627 = ɵngcc0.ɵɵnextContext(); return ctx_r1627.onAnimationStart($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const msg_r1623 = ctx.$implicit;
    const i_r1624 = ctx.index;
    const ctx_r1622 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("message", msg_r1623)("index", i_r1624)("template", ctx_r1622.template)("@toastAnimation", undefined)("showTransformOptions", ctx_r1622.showTransformOptions)("hideTransformOptions", ctx_r1622.hideTransformOptions)("showTransitionOptions", ctx_r1622.showTransitionOptions)("hideTransitionOptions", ctx_r1622.hideTransitionOptions);
} }
