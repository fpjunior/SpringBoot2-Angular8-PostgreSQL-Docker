...
function PanelMenuSub_ng_template_1_li_1_a_1_span_1_Template(rf, ctx) { if (rf & 1) {
    ...
    const child_r602 = ɵngcc0.ɵɵnextContext(3).$implicit;
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction2(1, _c0, !child_r602.expanded, child_r602.expanded));
} }
function PanelMenuSub_ng_template_1_li_1_a_1_span_2_Template(rf, ctx) { if (rf & 1) {
    ɵngcc0.ɵɵelement(0, "span", 15);
} if (rf & 2) {
    const child_r602 = ɵngcc0.ɵɵnextContext(3).$implicit;
    ɵngcc0.ɵɵproperty("ngClass", child_r602.icon);
} }
...
function PanelMenuSub_ng_template_1_li_1_a_1_ng_template_4_Template(rf, ctx) { if (rf & 1) {
    ...
    const child_r602 = ɵngcc0.ɵɵnextContext(3).$implicit;
    ɵngcc0.ɵɵproperty("innerHTML", child_r602.label, ɵngcc0.ɵɵsanitizeHtml);
} }
...
function PanelMenuSub_ng_template_1_li_1_a_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function PanelMenuSub_ng_template_1_li_1_a_1_Template_a_click_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r618); const child_r602 = ɵngcc0.ɵɵnextContext(2).$implicit; const ctx_r617 = ɵngcc0.ɵɵnextContext(); return ctx_r617.handleClick($event, child_r602); });
    ...
    const _r611 = ɵngcc0.ɵɵreference(5);
    const child_r602 = ɵngcc0.ɵɵnextContext(2).$implicit;
    const ctx_r605 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction1(11, _c1, child_r602.disabled));
    ɵngcc0.ɵɵattribute("href", child_r602.url, ɵngcc0.ɵɵsanitizeUrl)("tabindex", !ctx_r605.item.expanded ? null : child_r602.disabled ? null : "0")("id", child_r602.id)("aria-expanded", child_r602.expanded)("target", child_r602.target)("title", child_r602.title);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", child_r602.items);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", child_r602.icon);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", child_r602.escape !== false)("ngIfElse", _r611);
} }
...
function PanelMenuSub_ng_template_1_li_1_a_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function PanelMenuSub_ng_template_1_li_1_a_2_Template_a_click_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r631); const child_r602 = ɵngcc0.ɵɵnextContext(2).$implicit; const ctx_r630 = ɵngcc0.ɵɵnextContext(); return ctx_r630.handleClick($event, child_r602); });
    ...
    const _r624 = ɵngcc0.ɵɵreference(5);
    const child_r602 = ɵngcc0.ɵɵnextContext(2).$implicit;
    const ctx_r606 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("routerLink", child_r602.routerLink)("queryParams", child_r602.queryParams)("routerLinkActive", "p-menuitem-link-active")("routerLinkActiveOptions", child_r602.routerLinkActiveOptions || ɵngcc0.ɵɵpureFunction0(20, _c2))("ngClass", ɵngcc0.ɵɵpureFunction1(21, _c1, child_r602.disabled))("fragment", child_r602.fragment)("queryParamsHandling", child_r602.queryParamsHandling)("preserveFragment", child_r602.preserveFragment)("skipLocationChange", child_r602.skipLocationChange)("replaceUrl", child_r602.replaceUrl)("state", child_r602.state);
    ɵngcc0.ɵɵattribute("tabindex", !ctx_r606.item.expanded ? null : child_r602.disabled ? null : "0")("id", child_r602.id)("aria-expanded", child_r602.expanded)("target", child_r602.target)("title", child_r602.title);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", child_r602.items);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", child_r602.icon);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", child_r602.escape !== false)("ngIfElse", _r624);
} }
function PanelMenuSub_ng_template_1_li_1_p_panelMenuSub_3_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("item", child_r602)("expanded", child_r602.expanded)("transitionOptions", ctx_r607.transitionOptions);
} }
function PanelMenuSub_ng_template_1_li_1_Template(rf, ctx) { if (rf & 1) {
    ...
    const child_r602 = ɵngcc0.ɵɵnextContext().$implicit;
    ɵngcc0.ɵɵclassProp("p-hidden", child_r602.visible === false);
    ɵngcc0.ɵɵproperty("ngClass", child_r602.styleClass)("ngStyle", child_r602.style);
    ɵngcc0.ɵɵadvance(1);
...
function PanelMenuSub_ng_template_1_Template(rf, ctx) { if (rf & 1) {
    ...
    const child_r602 = ctx.$implicit;
    ɵngcc0.ɵɵproperty("ngIf", child_r602.separator);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", !child_r602.separator);
} }
...
function PanelMenu_ng_container_1_a_3_span_1_Template(rf, ctx) { if (rf & 1) {
    ...
    const item_r637 = ɵngcc0.ɵɵnextContext(2).$implicit;
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction2(1, _c8, !item_r637.expanded, item_r637.expanded));
} }
function PanelMenu_ng_container_1_a_3_span_2_Template(rf, ctx) { if (rf & 1) {
    ɵngcc0.ɵɵelement(0, "span", 13);
} if (rf & 2) {
    const item_r637 = ɵngcc0.ɵɵnextContext(2).$implicit;
    ɵngcc0.ɵɵproperty("ngClass", item_r637.icon);
} }
function PanelMenu_ng_container_1_a_3_span_3_Template(rf, ctx) { if (rf & 1) {
    ...
    const item_r637 = ɵngcc0.ɵɵnextContext(2).$implicit;
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵtextInterpolate(item_r637.label);
} }
function PanelMenu_ng_container_1_a_3_ng_template_4_Template(rf, ctx) { if (rf & 1) {
    ɵngcc0.ɵɵelement(0, "span", 15);
} if (rf & 2) {
    const item_r637 = ɵngcc0.ɵɵnextContext(2).$implicit;
    ɵngcc0.ɵɵproperty("innerHTML", item_r637.label, ɵngcc0.ɵɵsanitizeHtml);
} }
function PanelMenu_ng_container_1_a_3_Template(rf, ctx) { if (rf & 1) {
    const _r653 = ɵngcc0.ɵɵgetCurrentView();
    ɵngcc0.ɵɵelementStart(0, "a", 7);
    ɵngcc0.ɵɵlistener("click", function PanelMenu_ng_container_1_a_3_Template_a_click_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r653); const item_r637 = ɵngcc0.ɵɵnextContext().$implicit; const ctx_r652 = ɵngcc0.ɵɵnextContext(); return ctx_r652.handleClick($event, item_r637); });
    ...
    const _r646 = ɵngcc0.ɵɵreference(5);
    const item_r637 = ɵngcc0.ɵɵnextContext().$implicit;
    ɵngcc0.ɵɵattribute("href", item_r637.url, ɵngcc0.ɵɵsanitizeUrl)("tabindex", item_r637.disabled ? null : "0")("id", item_r637.id)("target", item_r637.target)("title", item_r637.title)("aria-expanded", item_r637.expanded)("id", item_r637.id + "_header")("aria-controls", item_r637.id + "_content");
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", item_r637.items);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", item_r637.icon);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", item_r637.escape !== false)("ngIfElse", _r646);
} }
...
function PanelMenu_ng_container_1_a_4_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function PanelMenu_ng_container_1_a_4_Template_a_click_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r666); const item_r637 = ɵngcc0.ɵɵnextContext().$implicit; const ctx_r665 = ɵngcc0.ɵɵnextContext(); return ctx_r665.handleClick($event, item_r637); });
    ...
    const _r659 = ɵngcc0.ɵɵreference(5);
    const item_r637 = ɵngcc0.ɵɵnextContext().$implicit;
    ɵngcc0.ɵɵproperty("routerLink", item_r637.routerLink)("queryParams", item_r637.queryParams)("routerLinkActive", "p-menuitem-link-active")("routerLinkActiveOptions", item_r637.routerLinkActiveOptions || ɵngcc0.ɵɵpureFunction0(18, _c2))("fragment", item_r637.fragment)("queryParamsHandling", item_r637.queryParamsHandling)("preserveFragment", item_r637.preserveFragment)("skipLocationChange", item_r637.skipLocationChange)("replaceUrl", item_r637.replaceUrl)("state", item_r637.state);
    ɵngcc0.ɵɵattribute("target", item_r637.target)("title", item_r637.title)("id", item_r637.id)("tabindex", item_r637.disabled ? null : "0");
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", item_r637.items);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", item_r637.icon);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", item_r637.escape !== false)("ngIfElse", _r659);
} }
function PanelMenu_ng_container_1_div_5_Template(rf, ctx) { if (rf & 1) {
    const _r670 = ɵngcc0.ɵɵgetCurrentView();
    ɵngcc0.ɵɵelementStart(0, "div", 18);
    ɵngcc0.ɵɵlistener("@rootItem.done", function PanelMenu_ng_container_1_div_5_Template_div_animation_rootItem_done_0_listener() { ɵngcc0.ɵɵrestoreView(_r670); const ctx_r669 = ɵngcc0.ɵɵnextContext(2); return ctx_r669.onToggleDone(); });
    ...
    ɵngcc0.ɵɵproperty("@rootItem", item_r637.expanded ? ɵngcc0.ɵɵpureFunction1(9, _c5, ɵngcc0.ɵɵpureFunction1(7, _c4, ctx_r642.animating ? ctx_r642.transitionOptions : "0ms")) : ɵngcc0.ɵɵpureFunction1(13, _c7, ɵngcc0.ɵɵpureFunction1(11, _c6, ctx_r642.transitionOptions)));
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵattribute("id", item_r637.id + "_content")("aria-labelledby", item_r637.id + "_header");
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("item", item_r637)("expanded", true)("transitionOptions", ctx_r642.transitionOptions)("root", true);
} }
...
function PanelMenu_ng_container_1_Template(rf, ctx) { if (rf & 1) {
    ...
    const item_r637 = ctx.$implicit;
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction1(8, _c9, item_r637.visible === false));
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵclassMap(item_r637.styleClass);
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction2(10, _c10, item_r637.expanded, item_r637.disabled))("ngStyle", item_r637.style);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", !item_r637.routerLink);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", item_r637.routerLink);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", item_r637.items);
