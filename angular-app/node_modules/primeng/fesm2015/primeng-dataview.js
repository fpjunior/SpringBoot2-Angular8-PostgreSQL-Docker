...
function DataView_div_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵclassMap("p-dataview-loading-icon pi-spin " + ctx_r348.loadingIcon);
} }
...
function DataView_div_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵproperty("ngTemplateOutlet", ctx_r349.headerTemplate);
} }
function DataView_p_paginator_3_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("onPageChange", function DataView_p_paginator_3_Template_p_paginator_onPageChange_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r357); const ctx_r356 = ɵngcc0.ɵɵnextContext(); return ctx_r356.paginate($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r350 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("rows", ctx_r350.rows)("first", ctx_r350.first)("totalRecords", ctx_r350.totalRecords)("pageLinkSize", ctx_r350.pageLinks)("alwaysShow", ctx_r350.alwaysShowPaginator)("rowsPerPageOptions", ctx_r350.rowsPerPageOptions)("dropdownAppendTo", ctx_r350.paginatorDropdownAppendTo)("dropdownScrollHeight", ctx_r350.paginatorDropdownScrollHeight)("templateLeft", ctx_r350.paginatorLeftTemplate)("templateRight", ctx_r350.paginatorRightTemplate)("currentPageReportTemplate", ctx_r350.currentPageReportTemplate)("showFirstLastIcon", ctx_r350.showFirstLastIcon)("dropdownItemTemplate", ctx_r350.paginatorDropdownItemTemplate)("showCurrentPageReport", ctx_r350.showCurrentPageReport)("showJumpToPageDropdown", ctx_r350.showJumpToPageDropdown)("showPageLinks", ctx_r350.showPageLinks);
} }
...
function DataView_ng_template_6_Template(rf, ctx) { if (rf & 1) {
    ...
    const rowData_r358 = ctx.$implicit;
    const rowIndex_r359 = ctx.index;
    const ctx_r351 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("ngTemplateOutlet", ctx_r351.itemTemplate)("ngTemplateOutletContext", ɵngcc0.ɵɵpureFunction2(2, _c0, rowData_r358, rowIndex_r359));
} }
function DataView_div_8_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵtextInterpolate(ctx_r352.emptyMessage);
} }
function DataView_p_paginator_9_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("onPageChange", function DataView_p_paginator_9_Template_p_paginator_onPageChange_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r362); const ctx_r361 = ɵngcc0.ɵɵnextContext(); return ctx_r361.paginate($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r353 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("rows", ctx_r353.rows)("first", ctx_r353.first)("totalRecords", ctx_r353.totalRecords)("pageLinkSize", ctx_r353.pageLinks)("alwaysShow", ctx_r353.alwaysShowPaginator)("rowsPerPageOptions", ctx_r353.rowsPerPageOptions)("dropdownAppendTo", ctx_r353.paginatorDropdownAppendTo)("dropdownScrollHeight", ctx_r353.paginatorDropdownScrollHeight)("templateLeft", ctx_r353.paginatorLeftTemplate)("templateRight", ctx_r353.paginatorRightTemplate)("currentPageReportTemplate", ctx_r353.currentPageReportTemplate)("showFirstLastIcon", ctx_r353.showFirstLastIcon)("dropdownItemTemplate", ctx_r353.paginatorDropdownItemTemplate)("showCurrentPageReport", ctx_r353.showCurrentPageReport)("showJumpToPageDropdown", ctx_r353.showJumpToPageDropdown)("showPageLinks", ctx_r353.showPageLinks);
} }
...
function DataView_div_10_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵproperty("ngTemplateOutlet", ctx_r354.footerTemplate);
} }
