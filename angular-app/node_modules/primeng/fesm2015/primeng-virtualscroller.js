...
function VirtualScroller_div_1_Template(rf, ctx) { if (rf & 1) {
    ...
    const ctx_r1793 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵproperty("ngTemplateOutlet", ctx_r1793.headerTemplate);
} }
...
function VirtualScroller_ng_container_7_Template(rf, ctx) { if (rf & 1) {
    ...
    const i_r1800 = ctx.index;
    const c_r1801 = ctx.count;
    const f_r1802 = ctx.first;
    const l_r1803 = ctx.last;
    const e_r1804 = ctx.even;
    const o_r1805 = ctx.odd;
    const ctx_r1796 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngStyle", ɵngcc0.ɵɵpureFunction1(3, _c0, ctx_r1796.itemSize + "px"));
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngTemplateOutlet", item_r1799 ? ctx_r1796.itemTemplate : ctx_r1796.loadingItemTemplate)("ngTemplateOutletContext", ɵngcc0.ɵɵpureFunction7(5, _c1, item_r1799, i_r1800, c_r1801, f_r1802, l_r1803, e_r1804, o_r1805));
} }
...
function VirtualScroller_div_8_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵproperty("ngTemplateOutlet", ctx_r1797.footerTemplate);
} }
