...
function ToastItem_ng_container_3_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵclassMap("p-toast-message-icon pi" + (ctx_r1390.message.icon ? " " + ctx_r1390.message.icon : ""));
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction4(5, _c1, ctx_r1390.message.severity == "info", ctx_r1390.message.severity == "warn", ctx_r1390.message.severity == "error", ctx_r1390.message.severity == "success"));
    ɵngcc0.ɵɵadvance(3);
    ɵngcc0.ɵɵtextInterpolate(ctx_r1390.message.summary);
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵtextInterpolate(ctx_r1390.message.detail);
} }
function ToastItem_button_4_Template(rf, ctx) { if (rf & 1) {
    const _r1394 = ɵngcc0.ɵɵgetCurrentView();
    ɵngcc0.ɵɵelementStart(0, "button", 10);
    ɵngcc0.ɵɵlistener("click", function ToastItem_button_4_Template_button_click_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r1394); const ctx_r1393 = ɵngcc0.ɵɵnextContext(); return ctx_r1393.onCloseIconClick($event); })("keydown.enter", function ToastItem_button_4_Template_button_keydown_enter_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r1394); const ctx_r1395 = ɵngcc0.ɵɵnextContext(); return ctx_r1395.onCloseIconClick($event); });
...
function Toast_p_toastItem_2_Template(rf, ctx) { if (rf & 1) {
    const _r1401 = ɵngcc0.ɵɵgetCurrentView();
    ɵngcc0.ɵɵelementStart(0, "p-toastItem", 3);
    ɵngcc0.ɵɵlistener("onClose", function Toast_p_toastItem_2_Template_p_toastItem_onClose_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r1401); const ctx_r1400 = ɵngcc0.ɵɵnextContext(); return ctx_r1400.onMessageClose($event); })("@toastAnimation.start", function Toast_p_toastItem_2_Template_p_toastItem_animation_toastAnimation_start_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r1401); const ctx_r1402 = ɵngcc0.ɵɵnextContext(); return ctx_r1402.onAnimationStart($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const msg_r1398 = ctx.$implicit;
    const i_r1399 = ctx.index;
    const ctx_r1397 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("message", msg_r1398)("index", i_r1399)("template", ctx_r1397.template)("@toastAnimation", undefined)("showTransformOptions", ctx_r1397.showTransformOptions)("hideTransformOptions", ctx_r1397.hideTransformOptions)("showTransitionOptions", ctx_r1397.showTransitionOptions)("hideTransitionOptions", ctx_r1397.hideTransitionOptions);
} }
class ToastItem {
    constructor(zone) {
        this.zone = zone;
