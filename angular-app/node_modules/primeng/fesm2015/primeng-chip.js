...
function Chip_div_0_ng_template_3_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngIf", ctx_r159.icon);
} }
...
function Chip_div_0_span_6_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function Chip_div_0_span_6_Template_span_click_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r164); const ctx_r163 = ɵngcc0.ɵɵnextContext(2); return ctx_r163.close($event); })("keydown.enter", function Chip_div_0_span_6_Template_span_keydown_enter_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r164); const ctx_r165 = ɵngcc0.ɵɵnextContext(2); return ctx_r165.close($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r161 = ɵngcc0.ɵɵnextContext(2);
    ɵngcc0.ɵɵclassMap(ctx_r161.removeIcon);
...
function Chip_div_0_Template(rf, ctx) { if (rf & 1) {
    ...
    const _r158 = ɵngcc0.ɵɵreference(4);
    const ctx_r156 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵclassMap(ctx_r156.styleClass);
    ɵngcc0.ɵɵproperty("ngClass", ctx_r156.containerClass())("ngStyle", ctx_r156.style);
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵproperty("ngIf", ctx_r156.image)("ngIfElse", _r158);
    ɵngcc0.ɵɵadvance(3);
    ɵngcc0.ɵɵproperty("ngIf", ctx_r156.label);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", ctx_r156.removable);
} }
const _c0 = ["*"];
class Chip {
    constructor() {
