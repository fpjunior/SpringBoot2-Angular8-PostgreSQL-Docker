...
function Slider_span_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngStyle", ɵngcc0.ɵɵpureFunction2(1, _c3, ctx_r969.handleValues[0] + "%", ctx_r969.handleValues[1] - ctx_r969.handleValues[0] + "%"));
} }
...
function Slider_span_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngStyle", ɵngcc0.ɵɵpureFunction2(1, _c4, ctx_r970.handleValues[0] + "%", ctx_r970.handleValues[1] - ctx_r970.handleValues[0] + "%"));
} }
...
function Slider_span_3_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngStyle", ɵngcc0.ɵɵpureFunction1(1, _c5, ctx_r971.handleValue + "%"));
} }
...
function Slider_span_4_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngStyle", ɵngcc0.ɵɵpureFunction1(1, _c6, ctx_r972.handleValue + "%"));
} }
...
function Slider_span_5_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("keydown", function Slider_span_5_Template_span_keydown_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r978); const ctx_r977 = ɵngcc0.ɵɵnextContext(); return ctx_r977.onHandleKeydown($event); })("mousedown", function Slider_span_5_Template_span_mousedown_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r978); const ctx_r979 = ɵngcc0.ɵɵnextContext(); return ctx_r979.onMouseDown($event); })("touchstart", function Slider_span_5_Template_span_touchstart_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r978); const ctx_r980 = ɵngcc0.ɵɵnextContext(); return ctx_r980.onTouchStart($event); })("touchmove", function Slider_span_5_Template_span_touchmove_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r978); const ctx_r981 = ɵngcc0.ɵɵnextContext(); return ctx_r981.onTouchMove($event); })("touchend", function Slider_span_5_Template_span_touchend_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r978); const ctx_r982 = ɵngcc0.ɵɵnextContext(); return ctx_r982.onTouchEnd($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r973 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵstyleProp("transition", ctx_r973.dragging ? "none" : null);
    ɵngcc0.ɵɵproperty("ngStyle", ɵngcc0.ɵɵpureFunction2(8, _c7, ctx_r973.orientation == "horizontal" ? ctx_r973.handleValue + "%" : null, ctx_r973.orientation == "vertical" ? ctx_r973.handleValue + "%" : null));
    ɵngcc0.ɵɵattribute("tabindex", ctx_r973.disabled ? null : ctx_r973.tabindex)("aria-valuemin", ctx_r973.min)("aria-valuenow", ctx_r973.value)("aria-valuemax", ctx_r973.max)("aria-labelledby", ctx_r973.ariaLabelledBy);
} }
...
function Slider_span_6_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("keydown", function Slider_span_6_Template_span_keydown_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r985); const ctx_r984 = ɵngcc0.ɵɵnextContext(); return ctx_r984.onHandleKeydown($event, 0); })("mousedown", function Slider_span_6_Template_span_mousedown_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r985); const ctx_r986 = ɵngcc0.ɵɵnextContext(); return ctx_r986.onMouseDown($event, 0); })("touchstart", function Slider_span_6_Template_span_touchstart_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r985); const ctx_r987 = ɵngcc0.ɵɵnextContext(); return ctx_r987.onTouchStart($event, 0); })("touchmove", function Slider_span_6_Template_span_touchmove_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r985); const ctx_r988 = ɵngcc0.ɵɵnextContext(); return ctx_r988.onTouchMove($event, 0); })("touchend", function Slider_span_6_Template_span_touchend_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r985); const ctx_r989 = ɵngcc0.ɵɵnextContext(); return ctx_r989.onTouchEnd($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r974 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵstyleProp("transition", ctx_r974.dragging ? "none" : null);
    ɵngcc0.ɵɵproperty("ngStyle", ɵngcc0.ɵɵpureFunction2(9, _c7, ctx_r974.rangeStartLeft, ctx_r974.rangeStartBottom))("ngClass", ɵngcc0.ɵɵpureFunction1(12, _c8, ctx_r974.handleIndex == 0));
    ɵngcc0.ɵɵattribute("tabindex", ctx_r974.disabled ? null : ctx_r974.tabindex)("aria-valuemin", ctx_r974.min)("aria-valuenow", ctx_r974.value ? ctx_r974.value[0] : null)("aria-valuemax", ctx_r974.max)("aria-labelledby", ctx_r974.ariaLabelledBy);
} }
function Slider_span_7_Template(rf, ctx) { if (rf & 1) {
    const _r992 = ɵngcc0.ɵɵgetCurrentView();
    ɵngcc0.ɵɵelementStart(0, "span", 7, 9);
    ɵngcc0.ɵɵlistener("keydown", function Slider_span_7_Template_span_keydown_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r992); const ctx_r991 = ɵngcc0.ɵɵnextContext(); return ctx_r991.onHandleKeydown($event, 1); })("mousedown", function Slider_span_7_Template_span_mousedown_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r992); const ctx_r993 = ɵngcc0.ɵɵnextContext(); return ctx_r993.onMouseDown($event, 1); })("touchstart", function Slider_span_7_Template_span_touchstart_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r992); const ctx_r994 = ɵngcc0.ɵɵnextContext(); return ctx_r994.onTouchStart($event, 1); })("touchmove", function Slider_span_7_Template_span_touchmove_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r992); const ctx_r995 = ɵngcc0.ɵɵnextContext(); return ctx_r995.onTouchMove($event, 1); })("touchend", function Slider_span_7_Template_span_touchend_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r992); const ctx_r996 = ɵngcc0.ɵɵnextContext(); return ctx_r996.onTouchEnd($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r975 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵstyleProp("transition", ctx_r975.dragging ? "none" : null);
    ɵngcc0.ɵɵproperty("ngStyle", ɵngcc0.ɵɵpureFunction2(9, _c7, ctx_r975.rangeEndLeft, ctx_r975.rangeEndBottom))("ngClass", ɵngcc0.ɵɵpureFunction1(12, _c8, ctx_r975.handleIndex == 1));
    ɵngcc0.ɵɵattribute("tabindex", ctx_r975.disabled ? null : ctx_r975.tabindex)("aria-valuemin", ctx_r975.min)("aria-valuenow", ctx_r975.value ? ctx_r975.value[1] : null)("aria-valuemax", ctx_r975.max)("aria-labelledby", ctx_r975.ariaLabelledBy);
} }
