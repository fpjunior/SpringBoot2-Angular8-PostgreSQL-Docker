...
function DataView_div_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵclassMap("p-dataview-loading-icon pi-spin " + ctx_r412.loadingIcon);
} }
...
function DataView_div_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵproperty("ngTemplateOutlet", ctx_r413.headerTemplate);
} }
function DataView_p_paginator_3_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("onPageChange", function DataView_p_paginator_3_Template_p_paginator_onPageChange_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r421); var ctx_r420 = ɵngcc0.ɵɵnextContext(); return ctx_r420.paginate($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    var ctx_r414 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("rows", ctx_r414.rows)("first", ctx_r414.first)("totalRecords", ctx_r414.totalRecords)("pageLinkSize", ctx_r414.pageLinks)("alwaysShow", ctx_r414.alwaysShowPaginator)("rowsPerPageOptions", ctx_r414.rowsPerPageOptions)("dropdownAppendTo", ctx_r414.paginatorDropdownAppendTo)("dropdownScrollHeight", ctx_r414.paginatorDropdownScrollHeight)("templateLeft", ctx_r414.paginatorLeftTemplate)("templateRight", ctx_r414.paginatorRightTemplate)("currentPageReportTemplate", ctx_r414.currentPageReportTemplate)("showFirstLastIcon", ctx_r414.showFirstLastIcon)("dropdownItemTemplate", ctx_r414.paginatorDropdownItemTemplate)("showCurrentPageReport", ctx_r414.showCurrentPageReport)("showJumpToPageDropdown", ctx_r414.showJumpToPageDropdown)("showPageLinks", ctx_r414.showPageLinks);
} }
...
function DataView_ng_template_6_Template(rf, ctx) { if (rf & 1) {
    ...
    var rowData_r422 = ctx.$implicit;
    var rowIndex_r423 = ctx.index;
    var ctx_r415 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("ngTemplateOutlet", ctx_r415.itemTemplate)("ngTemplateOutletContext", ɵngcc0.ɵɵpureFunction2(2, _c0, rowData_r422, rowIndex_r423));
} }
...
function DataView_p_paginator_9_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("onPageChange", function DataView_p_paginator_9_Template_p_paginator_onPageChange_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r426); var ctx_r425 = ɵngcc0.ɵɵnextContext(); return ctx_r425.paginate($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    var ctx_r417 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("rows", ctx_r417.rows)("first", ctx_r417.first)("totalRecords", ctx_r417.totalRecords)("pageLinkSize", ctx_r417.pageLinks)("alwaysShow", ctx_r417.alwaysShowPaginator)("rowsPerPageOptions", ctx_r417.rowsPerPageOptions)("dropdownAppendTo", ctx_r417.paginatorDropdownAppendTo)("dropdownScrollHeight", ctx_r417.paginatorDropdownScrollHeight)("templateLeft", ctx_r417.paginatorLeftTemplate)("templateRight", ctx_r417.paginatorRightTemplate)("currentPageReportTemplate", ctx_r417.currentPageReportTemplate)("showFirstLastIcon", ctx_r417.showFirstLastIcon)("dropdownItemTemplate", ctx_r417.paginatorDropdownItemTemplate)("showCurrentPageReport", ctx_r417.showCurrentPageReport)("showJumpToPageDropdown", ctx_r417.showJumpToPageDropdown)("showPageLinks", ctx_r417.showPageLinks);
} }
...
function DataView_div_10_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵproperty("ngTemplateOutlet", ctx_r418.footerTemplate);
} }
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(DataViewModule, { declarations: [DataView,
        DataViewLayoutOptions], imports: [ɵngcc2.CommonModule, ɵngcc1.SharedModule, ɵngcc3.PaginatorModule], exports: [DataView, ɵngcc1.SharedModule, DataViewLayoutOptions] }); })();
