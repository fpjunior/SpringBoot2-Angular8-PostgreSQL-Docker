...
function TabMenu_li_3_a_1_ng_container_1_span_1_Template(rf, ctx) { if (rf & 1) {
    ...
    var item_r1264 = ɵngcc0.ɵɵnextContext(3).$implicit;
    ɵngcc0.ɵɵproperty("ngClass", item_r1264.icon);
} }
function TabMenu_li_3_a_1_ng_container_1_span_2_Template(rf, ctx) { if (rf & 1) {
    ...
    var item_r1264 = ɵngcc0.ɵɵnextContext(3).$implicit;
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵtextInterpolate(item_r1264.label);
} }
function TabMenu_li_3_a_1_ng_container_1_ng_template_3_Template(rf, ctx) { if (rf & 1) {
    ɵngcc0.ɵɵelement(0, "span", 17);
} if (rf & 2) {
    var item_r1264 = ɵngcc0.ɵɵnextContext(3).$implicit;
    ɵngcc0.ɵɵproperty("innerHTML", item_r1264.label, ɵngcc0.ɵɵsanitizeHtml);
} }
function TabMenu_li_3_a_1_ng_container_1_Template(rf, ctx) { if (rf & 1) {
    ...
    var _r1272 = ɵngcc0.ɵɵreference(4);
    var item_r1264 = ɵngcc0.ɵɵnextContext(2).$implicit;
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", item_r1264.icon);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", item_r1264.escape !== false)("ngIfElse", _r1272);
} }
...
function TabMenu_li_3_a_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function TabMenu_li_3_a_1_Template_a_click_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r1279); var item_r1264 = ɵngcc0.ɵɵnextContext().$implicit; var ctx_r1278 = ɵngcc0.ɵɵnextContext(); return ctx_r1278.itemClick($event, item_r1264); });
    ...
    var ctx_r1281 = ɵngcc0.ɵɵnextContext();
    var item_r1264 = ctx_r1281.$implicit;
    var i_r1265 = ctx_r1281.index;
    var ctx_r1266 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵattribute("href", item_r1264.url, ɵngcc0.ɵɵsanitizeUrl)("tabindex", item_r1264.disabled ? null : "0")("target", item_r1264.target)("title", item_r1264.title)("id", item_r1264.id);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", !ctx_r1266.itemTemplate);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngTemplateOutlet", ctx_r1266.itemTemplate)("ngTemplateOutletContext", ɵngcc0.ɵɵpureFunction2(8, _c2, item_r1264, i_r1265));
} }
...
function TabMenu_li_3_a_2_ng_container_1_Template(rf, ctx) { if (rf & 1) {
    ...
    var _r1286 = ɵngcc0.ɵɵreference(4);
    var item_r1264 = ɵngcc0.ɵɵnextContext(2).$implicit;
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", item_r1264.icon);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", item_r1264.escape !== false)("ngIfElse", _r1286);
} }
...
function TabMenu_li_3_a_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function TabMenu_li_3_a_2_Template_a_click_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r1293); var item_r1264 = ɵngcc0.ɵɵnextContext().$implicit; var ctx_r1292 = ɵngcc0.ɵɵnextContext(); return ctx_r1292.itemClick($event, item_r1264); });
    ...
    var item_r1264 = ctx_r1295.$implicit;
    var i_r1265 = ctx_r1295.index;
    var ctx_r1267 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("routerLink", item_r1264.routerLink)("queryParams", item_r1264.queryParams)("routerLinkActive", "p-menuitem-link-active")("routerLinkActiveOptions", item_r1264.routerLinkActiveOptions || ɵngcc0.ɵɵpureFunction0(17, _c3))("fragment", item_r1264.fragment)("queryParamsHandling", item_r1264.queryParamsHandling)("preserveFragment", item_r1264.preserveFragment)("skipLocationChange", item_r1264.skipLocationChange)("replaceUrl", item_r1264.replaceUrl)("state", item_r1264.state);
    ɵngcc0.ɵɵattribute("tabindex", item_r1264.disabled ? null : "0")("target", item_r1264.target)("title", item_r1264.title)("id", item_r1264.id);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", !ctx_r1267.itemTemplate);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngTemplateOutlet", ctx_r1267.itemTemplate)("ngTemplateOutletContext", ɵngcc0.ɵɵpureFunction2(18, _c2, item_r1264, i_r1265));
} }
...
function TabMenu_li_3_Template(rf, ctx) { if (rf & 1) {
    ...
    var item_r1264 = ctx.$implicit;
    var ctx_r1262 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction3(5, _c4, item_r1264.disabled, ctx_r1262.activeItem == item_r1264, item_r1264.visible === false));
    ɵngcc0.ɵɵattribute("aria-selected", ctx_r1262.activeItem == item_r1264)("aria-expanded", ctx_r1262.activeItem == item_r1264);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", !item_r1264.routerLink);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", item_r1264.routerLink);
} }
'use strict';
